    ...
    public void refreshStats() {
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                Map<String, Integer> stats = dashboardController.fetchDashboardStats();
                if (stats != null) {
                ...
                currentLogs = dashboardController.fetchRecentActivity();
                SwingUtilities.invokeLater(() -> {
                    activityModel.clear();
                    if (currentLogs != null) {
                ...
                Map<String, Integer> trends = dashboardController.fetchAppointmentTrends();
                SwingUtilities.invokeLater(() -> {
                    dataset.clear();
                    if (trends != null) {
